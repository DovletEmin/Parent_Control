...
class ScreenStreamService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        initWebRtc(resultCode, resultData)
        registerReceivers()

        // Notify parent we're ready for WebRTC signaling
        DeviceWebSocket.instance.send(
            WsMessage(type = "screen_ready", parentId = parentId)
        )

        return START_NOT_STICKY
    }

    private fun initWebRtc(resultCode: Int, resultData: Intent) {
        ...
        localVideoTrack = peerConnectionFactory!!.createVideoTrack("screen0", videoSource)
        ...
        // Add local video track (screen capture, no audio)
    ...
    private fun registerReceivers() {
        val filter = IntentFilter().apply {
            addAction(ACTION_SCREEN_OFFER)
            addAction(ACTION_SCREEN_ICE)
        }
    ...
    private fun createNotification(): Notification {
        ...
        return NotificationCompat.Builder(this, App.CHANNEL_SCREEN)
            .setContentTitle(getString(R.string.app_name))
            .setContentText(getString(R.string.notification_screen_active))
    ...
    companion object {
        ...
        const val ACTION_SCREEN_OFFER = "com.parentcontrol.child.SCREEN_OFFER"
        const val ACTION_SCREEN_ICE = "com.parentcontrol.child.SCREEN_ICE"
    }
}
